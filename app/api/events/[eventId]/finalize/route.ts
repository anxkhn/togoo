  ...
  try {
    ...
    await db
      ...
      .values({
        ...
        location_name: parsed.data.location_name?.trim() || null,
        location_address: parsed.data.location_address?.trim() || null,
        google_maps_url: parsed.data.google_maps_url?.trim() || null,
        invite_message: parsed.data.invite_message?.trim() || null,
