import { r as __toESM, t as require_react } from "./react-BTme1M8l.js";
import { a as stripBasePath, n as toBrowserNavigationHref, r as toSameOriginAppPath } from "./url-utils-FXwuJ3Kt.js";
...
async function navigateClient(url) {
	...
	try {
		...
		const React = (await import("./react-BTme1M8l.js").then((n) => /* @__PURE__ */ __toESM(n.t(), 1))).default;
		assertStillCurrent();
