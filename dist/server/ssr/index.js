...
import { a as stripBasePath, n as toBrowserNavigationHref, r as toSameOriginAppPath } from "./assets/url-utils-FXwuJ3Kt.js";
...
var client_references_default = {
	"80177f1a457a": async () => {
		return (await import("./assets/facade__virtual_vinext-rsc-entry-Ck5Bgrzx.js")).export_80177f1a457a;
	},
	"d61b284da072": async () => {
		return (await import("./assets/facade__virtual_vinext-rsc-entry-Ck5Bgrzx.js")).export_d61b284da072;
	},
	"d45468d38d17": async () => {
		return (await import("./assets/facade__virtual_vinext-rsc-entry-Ck5Bgrzx.js")).export_d45468d38d17;
	},
	"630c0b371760": async () => {
		return (await import("./assets/facade__virtual_vinext-rsc-entry-Ck5Bgrzx.js")).export_630c0b371760;
	},
	"168aa4fcfd59": async () => {
		return (await import("./assets/facade__virtual_vinext-rsc-entry-Ck5Bgrzx.js")).export_168aa4fcfd59;
	},
	"593f344dc510": async () => {
		return (await import("./assets/facade__virtual_vinext-rsc-entry-Ck5Bgrzx.js")).export_593f344dc510;
	},
	"15c18cfaeeff": async () => {
		return (await import("./assets/facade__virtual_vinext-rsc-entry-Ck5Bgrzx.js")).export_15c18cfaeeff;
	},
	"c2747888630f": async () => {
		return (await import("./assets/facade__virtual_vinext-rsc-entry-Ck5Bgrzx.js")).export_c2747888630f;
	}
};
//#endregion
...
//#endregion
export { toRscUrl as a, useRouter as c, app_ssr_entry_default as default, handleSsr, prefetchRscResponse as i, getPrefetchedUrls as n, useParams as o, navigateClientSide as r, usePathname as s, getLayoutSegmentContext as t };
