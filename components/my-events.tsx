  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative card p-6 max-w-sm w-full shadow-xl animate-scale-in">
        <h3 className="font-display text-base font-semibold text-text mb-1">Remove from list?</h3>
        <p className="text-sm text-muted mb-5">
          <span className="font-medium text-text">{title}</span> will be removed from your recent events. This only affects this device.
        </p>
